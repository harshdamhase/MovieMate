  ...
  return (
    ...
    <div className="row video-container mt-4 " >
        ...
        <div className=' col-lg-4 col-sm-8 col-md-8 ms-5 info '>
          ...
          <div className='col-lg-12 col-sm-8 col-md-12  title-style me-5 ms-5 mt-2 inside textalign '>
           ...
           The film journeys alongside an unlikely pair, Ember and Wade, in a city where fire-, water-, land- and air-residents live together. The fiery young woman and the go-with-the-flow guy<br/> are about to discover something elemental: how much they actually have in common. </div>
          </div>
    ...
    <div className='also-like '>
      You May Also Like 
         ...
         {/* <ReviewCard  imgUrl="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@star-icon-202203010609.png,ox-24,oy-615,ow-29:ote-OS8xMCAgMTQ5LjdLIHZvdGVz,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00343918-bcrtrqpgtc-portrait.jpg" 
         Title="The Kerla Story"
         Gener=" Drama"
         Overview=""/> */}
         ...
         <div className='poster-container'>
          ...
          <img className='poster-img m-2' src='https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@star-icon-202203010609.png,ox-24,oy-615,ow-29:ote-OC40LzEwICA3Mi4zSyB2b3Rlcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00348725-qjtqfsmnqa-portrait.jpg'/>
