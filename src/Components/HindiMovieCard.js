...
function HindiMovieCard({imgUrl,filmName,timeDuration,filmType}) {
  return (
    <>
     <div className='card shadow-lg mb-2 h-100'style={{backgroundColor:'#282A3A'}}>
               <div class='card-img-effect'> <img src={imgUrl} class="card-img-top" alt="..." style={{height:'300px'}}/></div>
